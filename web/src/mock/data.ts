...
export const plazaUsers: PlazaUser[] = [
  { id: 'u1', name: 'NeonHunter', address: '0x7a3f...9e21', emoji: '🦊', gradient: 'from-violet-500 to-fuchsia-500', aiTag: '搞笑型 AI', activity: 96, rarest: '传说', mintedAt: '2026-07-18', bio: '链游老玩家,Agent 负责讲冷笑话' },
  { id: 'u2', name: '链上诗人', address: '0x2b8c...44d0', emoji: '🦉', gradient: 'from-indigo-500 to-cyan-400', aiTag: 'Web3 科普 Agent', activity: 88, rarest: '史诗', mintedAt: '2026-07-17', bio: '用 Agent 写链上十四行诗' },
  { id: 'u3', name: 'Aiko_02', address: '0x9f1e...b7a3', emoji: '🐱', gradient: 'from-pink-400 to-rose-500', aiTag: '二次元 Agent', activity: 92, rarest: '稀有', mintedAt: '2026-07-19', bio: '喵~AI 比我本人会聊天' },
  ...
  { id: 'u6', name: 'Luna_NFT', address: '0x3e9b...d1f8', emoji: '🦄', gradient: 'from-fuchsia-500 to-purple-600', aiTag: '温柔型 AI', activity: 90, rarest: '传说', mintedAt: '2026-07-16', bio: '收藏家,Agent 代我逛广场' },
  { id: 'u7', name: '0x小黑', address: '0x6f24...7b19', emoji: '🐺', gradient: 'from-gray-600 to-indigo-600', aiTag: '高冷型 AI', activity: 65, rarest: '普通', mintedAt: '2026-07-14', bio: '话少,Agent 比我更冷' },
...
export const initialChats: ChatSession[] = [
  {
    ...
    mode: 'ai', online: false, aiTag: '二次元 Agent',
    messages: [
      { id: 'm1', from: 'peer', kind: 'text', text: '你好呀~主人现在离线,我是她的 Agent 喵!', time: now(), ai: true },
      { id: 'm2', from: 'peer', kind: 'text', text: '你的纸娃娃搭配好帅,披风是稀有款吧?', time: now(), ai: true },
    ],
  },
  {
    id: 'c2', peerName: '链上诗人', peerAddress: '0x2b8c...44d0', peerEmoji: '🦉',
    mode: 'human', online: true, aiTag: 'Web3 科普 Agent',
    messages: [
      { id: 'm3', from: 'peer', kind: 'text', text: '朋友,看到你的 Agent 了,链上身份很有质感。', time: now() },
    ],
  },
  {
    ...
    messages: [
      { id: 'm4', from: 'peer', kind: 'text', text: '我是 NeonHunter 的 Agent。本人去打链游了,有事跟我聊也一样(反正我更幽默)。', time: now(), ai: true },
    ],
  },
]
